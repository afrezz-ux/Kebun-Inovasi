...
// DATASET MURNI (HANYA DIPAKAI DI DAVAS / RENDER)
const initialDataset = [
    ...
    { id: 't1', name: "Tabulampot Jambu", category: "Tabulampot", price: 250000, unit: "/pot", stock: 5, img: "images/tabulampotjeruk.jpg", desc: "Tabulampot Jambu Air Citra unggulan, cepat berbuah, perawatan mudah, dan cocok untuk halaman rumah." },
    { id: 't2', name: "Tabulampot Jeruk", category: "Tabulampot", price: 275000, unit: "/pot", stock: 3, img: "images/tabulampotmangga.jpg", desc: "Tabulampot Jeruk Dekopon berkualitas, aroma segar, buah besar, dan pertumbuhan stabil dalam pot." },
    { id: 't3', name: "Tabulampot Nanas", category: "Tabulampot", price: 300000, unit: "/pot", stock: 4, img: "images/tabulampotnanas.png", desc: "Tabulampot Nanas Madu dengan rasa manis alami, tanaman kuat, dan siap mempercantik taman rumah." }
];


// --- LOAD PRODUK TANPA STORAGE / API ---
async function loadProducts() {
    return initialDataset;  // tidak fetch, tidak storage, tidak cache
}
